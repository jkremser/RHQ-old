...
public class ConfigurationDefinitionTest extends JPATest {
    ...
    public void testStoreDefinition() throws Exception {
        ...
        entityMgr.persist(definition);

        testReadDefinition(entityMgr);
    }
    ...
    public void testEnumeratedValues() throws Exception {
        ...
        def.put(prop);
        entityMgr.persist(def);

        List<ConfigurationDefinition> definitions = entityMgr.createQuery(
        ...
        for (ConfigurationDefinition definition : definitions) {
            ...
            definition = entityMgr.merge(definition);
