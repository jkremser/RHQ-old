...
public class ResourceRelHistoryCriteria extends Criteria {
    ...
    public ResourceRelHistoryCriteria() {
        super(ResourceRelHistoryCriteria.class);
    ...
    public void addSortMtime(PageOrdering startTime) {
        this.sortStartTime = startTime;
    }

    public void addSortCtime(PageOrdering endTime) {
        this.sortEndTime = endTime;
    }
