...
public class PackageDetailsKey implements Serializable {
    ...
    public PackageDetailsKey(String name, String version, String release, String epoch, String packageTypeName,
    ...
    public int hashCode() {
        ...
        if (epoch != null) {
            result = (prime * result) + epoch.hashCode();
        }
    ...
    public boolean equals(Object obj) {
        ...
        if ((release == null && other.release != null) || (release != null && !release.equals(other.release))) {
            return false;
        }

        if ((epoch == null && other.epoch != null) || (epoch != null && !epoch.equals(other.epoch))) {
            return false;
        }
