...
@NamedQueries( {
    ...
    @NamedQuery(name = AdvisoryPackage.DELETE_IF_NO_CONTENT_SOURCES_OR_REPOS, query = "" //
        + "DELETE AdvisoryPackage advpkg " //
        + "WHERE advpkg.id IN " //
        + "  (SELECT advp.id FROM AdvisoryPackage advp " //
        + "   WHERE advp.pkg.repoPackageVersions IS EMPTY " //
        + "     AND advp.pkg.installedPackages IS EMPTY " //
        + "     AND advp.pkg.installedPackageHistory IS EMPTY " //
        + "   )")
...
public class AdvisoryPackage implements Serializable {
    ...
    public static final String DELETE_IF_NO_CONTENT_SOURCES_OR_REPOS = "AdvisoryPackage.deleteIfNoContentSourcesOrRepos";
